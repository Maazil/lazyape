...
{
    /// <summary>
    /// Controller for auto generated tasks.
    /// </summary>
    //TODO make this to a api controller instead.
    [Route("auto")]
    public class TaskAutoGeneratorController : Controller
    {
        ...
        /// <summary>
        /// Constructor for the auto generator controller.
        /// </summary>
        /// <param name="db"></param>
        /// <param name="um"></param>
        ...
        /// <summary>
        /// Auto generate tasks for all useres.
        /// </summary>
        [HttpGet]
        ...
        /// <summary>
        /// Remove all generated tasks between a given period.
        /// </summary>
        ...
        /// <summary>
        /// Remove all generated task on a user
        /// </summary>
        /// <param name="from">From date</param>
        /// <param name="to">To date</param>
        /// <param name="userID">User id of user you want to remove auto tasks from</param>
        ...
        /// <summary>
        /// Update the courses the users have in our database
        /// </summary>
        /// <returns> A dictionary with all the users as keys and the courses they own as a list of values</returns>
        ...
        /// <summary>
        /// Update the user courses on the a specific user
        /// </summary>
        /// <param name="userId">The user id of the user it is going to check</param>
        /// <returns> A dictionary with the user as key and the courses it own as a list of values</returns>
        ...
        /// <summary>
        /// Generate a dictionary with weekdays to the exam periode
        /// </summary>
        /// <param name="from"> From date</param>
        /// <param name="to"> To date</param>
        /// <returns> A dictionary with the all weekdays as keys and a list over all the days as values</returns>
        ...
        /// <summary>
        /// Generate a list with all weekdays to the exam period
        /// </summary>
        /// <param name="from">From date</param>
        /// <param name="to">To date</param>
        /// <returns>A list with all the weekdays</returns>
        ...
        /// <summary>
        /// Make a new auto generated task.
        /// </summary>
        /// <param name="day"> Day to start on</param>
        /// <param name="hour"> Hour to start on</param>
        /// <param name="course"> Course to start on</param>
        /// <param name="user"> User to add the task to</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Generator for all the auto generated tasks.
        /// </summary>
        /// <param name="courseList"> List of courses to generate tasks from</param>
        /// <param name="from"> From daye</param>
        /// <param name="lastDayBeforeExam"> To date</param>
        ...
        /// <summary>
        /// Auto generator for test case
        /// </summary>
        /// <param name="userId">User id of user it should add tasks to</param>
        [HttpGet]
        [Route("test")]
